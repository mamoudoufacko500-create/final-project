        ...
        <div className="absolue inset-0 bg-black/50 h-screen">
          <div className="relative mx-auto max-w-6xl flex items-center h-screen gap-10 justify-center text-white ">
            <div className="flex flex-col text-start gap-10 w-1/2">
              <h1>La mission</h1>
              <p className="font-bold text-5xl mx-auto max-w-2xl">
                Notre priorité absolue est d'offrir la meilleur qualité.
              </p>
            ...
            <div className="flex flex-col text-start gap-15 w-1/2">
              <p className="font-bold text-xl">
                ...
                eu ante vel mauris molestie dignissim non eget nunc. Integer ac
                massa orci. Suspendisse vulputate semper nunc eget rhoncus. Ut
                sit amet porta sem, interdum tincidunt libero. Nulla vel quam
                lobortis, varius est scelerisque, dapibus nisl.
              </p>
              <p className="font-bold text-xl">
                {" "}
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut id
                leo tempor, congue justo at, orci. Aliquam venenatis dui lectus,
                eu convallis turpis convallis et. Sensible.
              </p>
            </div>
          </div>
        </div>
